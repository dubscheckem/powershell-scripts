...
#get arp cache, IPV4 only and upload report to Reach	
get-netneighbor -addressfamily IPV4 | out-file "C:\ProgramData\Revolution\AzureIot\Upload-Reports\$($UnitSerialNum.Trim('"'))_arpCache.csv"
...
#get installed certs via posh provider
get-childitem -path Cert:\LocalMachine\Root | out-file "C:\ProgramData\Revolution\AzureIot\Upload-Reports\$($UnitSerialNum.Trim('"'))_installedRootCerts.csv"

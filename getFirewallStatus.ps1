...
Get-NetFirewallProfile | Select Name,Enabled | format-table | out-file "C:\ProgramData\Revolution\AzureIot\Upload-Reports\$($UnitSerialNum.Trim('"'))_FirewallCheck.csv"